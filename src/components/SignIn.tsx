...
function SignIn({ handleCloseModal }: SignInProps): JSX.Element {
  ...
  const handleOnChange = (event: any) => {
    ...
    setFormValidation((prevState) => ({
      ...prevState,
      emailValid: validateField(
        event.target.id,
        event.target.value,
        formValidation
      ).emailValid,
      passwordValid: validateField(
        event.target.id,
        event.target.value,
        formValidation
      ).passwordValid,
        ...
        <div className="grid grid-rows-2 grid-flow-row p-3">
          <div>
            <Input
              ...
              validationError={formValidation.formErrors.email}
            />
          </div>
          <div>
            <Input
              ...
              value={password}
              onChange={handleOnChange}
              validationError={formValidation.formErrors.password}
            />
          </div>
